...
See [Default Pipeline Assignment](/boboddy/guides/pipeline-assignment/)
for the full API.
...
- [Default Pipeline Assignment](/boboddy/guides/pipeline-assignment/) — routing
  incoming work items to pipelines.
